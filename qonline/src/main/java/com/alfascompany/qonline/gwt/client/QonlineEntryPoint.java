...
public class QonlineEntryPoint implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		final Button newButtonTest = new Button("Test");
		...
		RootPanel.get("sendButtonContainer").add(newButtonTest);
		...
		newButtonTest.addClickHandler(new ClickHandler() {

			public void onClick(ClickEvent event) {
				final Raffle raffle = new Raffle();// DAOLocator.instance().getDAO(RaffleDAO.class).getById("1");

				final FlowPanel container = new RaffleController().getContainer(raffle);
